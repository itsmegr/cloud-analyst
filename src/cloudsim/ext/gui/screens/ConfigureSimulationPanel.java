...
public class ConfigureSimulationPanel extends JPanel 
	...
	private JPanel createAdvancedTab(){
                System.out.println("Creating Advanced tab\n");
		int leftMargin = 50;
		int x = leftMargin;
		int y = 50;
		int vGap = 20;
		...
		compW = 240;
		compH = 30;
		JLabel lblLoadBalancing = new JLabel("<html>New Load balancing policy<br/>" +
				                                  "across the VM's in a single Data Center:</html>");
		...
		cmbLoadBalancingPolicy = new JComboBox(new String[]{
				...
				Constants.LOAD_BALANCE_LRU_THROTTLED,
		});
